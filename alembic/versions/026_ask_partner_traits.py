"""Спроси Астрид: вопрос про черты судьбоносного партнёра
...
_PRODUCT_CODE = "ask_love_partner_traits"
...
def upgrade() -> None:
    op.execute(
        sa.text(
            ...
            VALUES (:code, 'ask_answer', 'Черты судьбоносного партнёра', true, now(), now())
