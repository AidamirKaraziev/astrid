...
SPREADS: dict[SpreadType, SpreadSpec] = {
    SpreadType.WISH: SpreadSpec(
        ...
        question_hint=(
            "Загадай желание — о любви, деньгах, переменах или о нём.\n"
            "Опиши одним-двумя предложениями, например: «Хочу, чтобы он снова написал мне первым»."
        ),
        max_tokens=700,
    ),
    ...
    SpreadType.RELATIONSHIP: SpreadSpec(
        ...
        question_required=True,
        question_hint=(
            "О ком спросим карты? Напиши, кто он тебе и что между вами сейчас.\n"
            "Карты покажут, что он чувствует на самом деле — даже то, о чём молчит."
        ),
        max_tokens=1150,
    ),
}
