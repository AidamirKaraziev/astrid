...
# ︎ — текстовый вариатор: просит рисовать знак чёрно-белым, а не цветным эмодзи.
_ZODIAC_GLYPH = {
    "Овен": "♈︎", "Телец": "♉︎", "Близнецы": "♊︎", "Рак": "♋︎",
    "Лев": "♌︎", "Дева": "♍︎", "Весы": "♎︎", "Скорпион": "♏︎",
    "Стрелец": "♐︎", "Козерог": "♑︎", "Водолей": "♒︎", "Рыбы": "♓︎",
}
