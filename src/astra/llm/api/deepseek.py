"""Клиент DeepSeek API (OpenAI-compatible chat completions)."""
...
class DeepSeekProvider(BaseLlmProvider):
    ...
    def is_configured(self) -> bool:
        cfg = self._settings
        return cfg.deepseek_enabled and bool(cfg.deepseek_api_key.strip())
    ...
    def _build_payload(self, request: CompletionRequest, cfg: Settings) -> dict[str, object]:
        ...
        if request.extra.get("thinking_disabled"):
    ...
    async def complete(self, request: CompletionRequest) -> CompletionResult:
        ...
        timeout = request.timeout_seconds or cfg.deepseek_timeout_seconds
        headers = {
        ...
        try:
            ...
            return CompletionResult(None, self.map_http_error(exc, log_label="DeepSeek"))
