...
* **эмодзи по смыслу** — значки, тащащие чужой контекст (⚙️ 🔁 📢 🔔 💰), запрещены;
  остальное подбирается под смысл, это правило проекта, а не вкусовщина.
"""
...
PALETTE = "✨ 💫 🔮 🌀 💜 🌙 ⭐ 🌌 ♈♉♊♋♌♍♎♏♐♑♒♓ 🪐 🃏"
# Запрещены не «служебные» значки как класс, а те, что тащат за собой чужой
# контекст: админку, плеер, рекламный рупор, деньги. Остальное модель
# подбирает по смыслу — правило в vault «текст бота сканируется сверху вниз
