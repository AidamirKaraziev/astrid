...
> **Статус 2026-07-21:** таро-расклады (#16–18) уже запущены платно по 50 ⭐ через Telegram Stars («Таро: решение» стал «Загадай желание»); «Карта дня» бесплатна. Ограничение «deadtiger CPU-only LLM ≤4B» неактуально — LLM облачная (DeepSeek). Этап 2 — карта/ЮKassa. Таблицы ниже — оценки на 2026-06-13.
